...
from app.routers import knowledge as router_knowledge
...
ROUTERS = [router_station, router_array, router_inverter, router_combiner, router_stringmon, router_irradiance, router_cleaning, router_inspection, router_defect, router_repair, router_knowledge, router_sparepart, router_generation, router_curtail, router_alarm, router_permit, router_contractor, router_training, router_settlement]
